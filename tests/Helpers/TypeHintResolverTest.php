...
namespace Ufo\DTO\Tests\Helpers;
...
class TypeHintResolverTest extends TestCase
{
    ...
    public function testJsonSchemaToPhpDescription(): void
    {
        ...
        $this->assertSame('null|string', TypeHintResolver::jsonSchemaToTypeDescription([
                'oneOf' => [
                    ['type' => 'string'],
                    ['type' => 'null'],
                ],
    ...
    public function testJsonSchemaToPhpType(): void
    {
        ...
        $this->assertSame('null|array', $resultOnOff);
    }
    ...
    public function testObjectJsonSchema(): void
    {
        ...
        $this->assertSame('null|CreateInvoiceDetailDTO', $result);
        $this->assertSame('null|DTO\CreateInvoiceDetailDTO', $resultWithNamespace);
        $this->assertEquals('Qqq', $resultObject);
        $this->assertEquals('DTO\Qqq', $resultObjectWithNamespace);
    }

    public function testEnumToJson(): void
    {
        $assertSchemaString = json_decode('{"type":"string","classFQCN":"Ufo\\\\DTO\\\\Tests\\\\Fixtures\\\\Enum\\\\StringEnum","x-ufo-enum":{"name":"StringEnum","values":{"A":"a","B":"b","C":"c"}},"enum":["a","b","c"]}', true);
        $assertSchemaInt = json_decode('{"type":"integer","classFQCN":"Ufo\\\\DTO\\\\Tests\\\\Fixtures\\\\Enum\\\\IntEnum","x-ufo-enum":{"name":"IntEnum","values":{"A":1,"B":2,"C":3}},"enum":[1,2,3]}', true);

        $schemaString = TypeHintResolver::typeDescriptionToJsonSchema(StringEnum::class);
        $this->assertEquals($assertSchemaString, $schemaString);

        $schemaInt = TypeHintResolver::typeDescriptionToJsonSchema(IntEnum::class);
        $this->assertEquals($assertSchemaInt, $schemaInt);
    }

    public function testJsonToEnum(): void
    {
        $string = json_decode('{"type":"string","x-ufo-enum":{"name":"StringEnum","values":{"A":"a","B":"b","C":"c"}},"enum":["a","b","c"]}', true);
        ...
        $this->assertEquals('DDD\StringEnum', $typeStringWithNamespace);
