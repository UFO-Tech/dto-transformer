...
use Ufo\DTO\Tests\Fixtures\DTO\ObjectArrayAttributesDTO;
...
final class DTOTransformerFromSmartArrayTest extends TestCase
{
    ...
    {
        return [
            DTOTransformer::DTO_NS_KEY => 'Ufo\DTO\Tests\Fixtures\DTO'
        ];
    }
    ...
    public function testRoundTripAliasDto(): void
    {
        ...
        $smart = DTOTransformer::toArray($src, asSmartArray: true);
        $restored = DTOTransformer::fromArray(AliasDTO::class, $smart, namespaces: $this->namespaces());
    ...
    public function testRoundTripObjectWithArrayDto(): void
    {
        ...
        $smart = DTOTransformer::toArray($src, asSmartArray: true);
        $restored = DTOTransformer::fromArray(ObjectWithArrayDTO::class, $smart, namespaces: $this->namespaces());
    ...
    public function testFromSmartArrayWithRenameKey(): void
    {
        ...
        /** @var AliasDTO $dto */
        $dto = DTOTransformer::fromArray(AliasDTO::class, $data, renameKey: $renameKey, namespaces: $this->namespaces());
    ...
    public function testThrowsWhenClassNameKeyMissing(): void
    {
        ...
        TransformerFactory::fromArrayTransformer()->transformFromSmartArray(
            ['id' => 1, 'name' => 'nope'],
    ...
    public function testThrowsWhenNamespaceMappingMissing(): void
    {
        ...
        TransformerFactory::fromArrayTransformer()->transformFromSmartArray($data, namespaces: []);
    }
    ...
    public function testFromSmartArrayItemDtoWhenFriendHasExplicitClassNameDummyDto(): void
    {
        ...
        /** @var ItemDTO $restored */
        $restored = DTOTransformer::fromArray(DummyDTO::class, $smart, namespaces: $this->namespaces());
    ...
    public function testFromSmartArrayItemDtoWhenFriendExplicitClassNameMismatchThrows(): void
    {
        ...
        DTOTransformer::fromArray(ItemDTO::class, $smart, namespaces: $this->namespaces());
    }
