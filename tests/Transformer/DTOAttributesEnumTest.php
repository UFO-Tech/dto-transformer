...
class DTOAttributesEnumTest extends TestCase
{
    ...
    public function testTransformDtoCollectionFallsBackWhenStrictDisabled(): void
    {
        $property = new ReflectionProperty(MemberWithFriendsDTO::class, 'friends');
        $method = new ReflectionMethod(self::class, 'getMemberDtoCollection');
        $attribute = $method->getAttributes()[0];
    ...
    protected function getSmartDummyDto(): object
    {
        return new DummyDTO(1, 'dummy');
    }
    ...
    public function testAttrDtoResolvesSmartClassNameWhenProcessedDirectly(): void
    {
        $property = new ReflectionProperty(DummyDTO::class, 'name');
        $method = new ReflectionMethod(self::class, 'getSmartDummyDto');
        $attribute = $method->getAttributes()[0];
